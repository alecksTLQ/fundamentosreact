...
Peticiono HTTP 
con Axios y su metodo get, usar para dar soporte a navegadores antiguos
 */
...
class App extends Component{
  ...
  manejador(event){
    ...
    /* 
      axios get hace la solicitud al api
        - se le pasa la url, con los params
        - el then obtiene respuesta a traves del res
        - para acceder a los datos se hace usando res.data
     */
    axios.get(url, {params:{t: title}})
    .then(res =>
        this.setState({
          movie: res.data,
          estado: false
